  ...
  const renderNewConversationButton = useCallback(() => (
    ...
    >
      ...
      <div className="relative p-3 lg:p-4">
        ...
        <p className="text-white/90 text-sm mb-3 lg:mb-4 leading-relaxed hidden lg:block">
    ...
    <>
      ...
      <div className={`${styles.conversationSidebar} ${styles.desktopOnly} ${themeClasses.main} ${className}`}>
        <div className="p-3 lg:p-6 flex-1 overflow-y-auto pb-1 lg:pb-8 min-h-0">
          <h2 className={`text-base lg:text-xl font-bold mb-2 lg:mb-6 ${themeClasses.text.primary}`}>
            Conversations
          </h2>
