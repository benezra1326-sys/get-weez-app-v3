...
const SimpleMobileChat = ({ user, initialMessage, establishmentName }) => {
  ...
  return (
    <>
      <style jsx>{`
        ...
        .simple-mobile-input-wrapper:focus-within {
          border-color: #10A37F;
          box-shadow: 0 0 0 2px rgba(16, 163, 127, 0.1);
        }
        
        .simple-mobile-textarea {
          width: 100%;
          border: none;
          outline: none;
        ...
        .simple-mobile-textarea::placeholder {
          color: ${isDarkMode ? 'rgba(255, 255, 255, 0.5)' : 'rgba(0, 0, 0, 0.5)'};
        }
        
        .simple-mobile-send-button {
          position: absolute;
          right: 8px;
          bottom: 8px;
          width: 32px;
        ...
        .simple-mobile-send-button:hover {
          background: ${input.trim() ? '#0D8A6B' : '#8E8EA0'};
        }
        
        .simple-mobile-send-button:disabled {
          cursor: not-allowed;
          opacity: 0.5;
        }
        ...
        .simple-mobile-message.user {
          display: flex;
          justify-content: flex-end;
        }
        
        .simple-mobile-message.assistant {
          display: flex;
          justify-content: flex-start;
        }
        
        .simple-mobile-message-bubble {
          max-width: 85%;
          padding: 12px 16px;
          border-radius: 18px;
        ...
        .simple-mobile-message.user .simple-mobile-message-bubble {
          background: #10A37F;
          color: white;
          border-bottom-right-radius: 4px;
        }
        
        .simple-mobile-message.assistant .simple-mobile-message-bubble {
          background: ${isDarkMode ? '#1F1F1F' : '#F7F7F8'};
          color: ${isDarkMode ? '#FFFFFF' : '#000000'};
        ...
        .simple-mobile-suggestion-card:hover {
          transform: translateY(-2px);
          box-shadow: 0 8px 25px rgba(0, 0, 0, 0.15);
        }
        
        .simple-mobile-suggestion-card:active {
          transform: translateY(0);
        }
        
        .simple-mobile-suggestion-icon {
          width: 40px;
          height: 40px;
          border-radius: 12px;
          display: flex;
        ...
        .simple-mobile-suggestion-title {
          font-weight: 600;
          font-size: 14px;
          margin-bottom: 4px;
          color: #1F2937;
        ...
        .simple-mobile-suggestion-description {
          font-size: 12px;
          color: #6B7280;
          line-height: 1.3;
        }
      ...
      <div className="simple-mobile-chat">
        ...
        {/* Messages */}
        <div className="simple-mobile-messages">
          {messages && messages.length > 0 ? (
            messages.map((msg) => (
              <div
                key={msg.id}
                className={`simple-mobile-message ${msg.role}`}
              >
                <div className="simple-mobile-message-bubble">
          ...
          {isLoading && (
            <div className="simple-mobile-message assistant">
              <div className="simple-mobile-message-bubble">
        ...
        {showSuggestions && messages && messages.length === 0 && (
          <div className="simple-mobile-suggestions">
            <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">
              Que puis-je faire pour vous ?
            </h3>
            <div className="simple-mobile-suggestion-grid">
              {suggestions.map((suggestion) => {
                const Icon = suggestion.icon
                return (
                  <div
                    key={suggestion.id}
                    className={`simple-mobile-suggestion-card ${suggestion.borderColor} ${suggestion.bgColor}`}
                    onClick={() => handleSuggestionClick(suggestion.suggestion)}
                  >
                    <div className={`simple-mobile-suggestion-icon bg-gradient-to-r ${suggestion.color} text-white`}>
                      {suggestion.image}
                    </div>
                    <div className="simple-mobile-suggestion-title">
                      {suggestion.title}
                    </div>
                    <div className="simple-mobile-suggestion-description">
        ...
        <div className="simple-mobile-input-container">
          <div className="simple-mobile-input-wrapper">
            <textarea
              ref={textareaRef}
              value={input}
            ...
            <button
              ...
              className="simple-mobile-send-button"
            >
              {isLoading ? (
...
export default SimpleMobileChat
