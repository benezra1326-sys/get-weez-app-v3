...
export default function NotificationSettings() {
  ...
  const notificationTypes = [
    ...
    {
      key: 'email',
      title: t('account.notifications.email'),
  ...
  const notificationCategories = [
    {
      key: 'requests',
      title: t('account.notifications.requests'),
      icon: <Bell size={16} />,
      description: 'Réponses à vos demandes'
    },
    {
      key: 'suggestions',
      title: t('account.notifications.suggestions'),
      icon: <Gift size={16} />,
      description: 'Nouvelles recommandations'
    },
    {
      key: 'reminders',
      title: t('account.notifications.reminders'),
      icon: <Clock size={16} />,
      description: 'Rappels de réservations'
    },
    {
      key: 'marketing',
      title: t('account.notifications.marketing'),
      icon: <Gift size={16} />,
