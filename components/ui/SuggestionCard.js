      ...
      <div className={`${styles.cardContent} ${currentSize.card}`}>
        ...
        <div className="flex items-center justify-between">
          ...
          <button 
            ...
            className={`${currentSize.button} bg-gradient-to-r from-white/20 to-white/30 hover:from-white/30 hover:to-white/40 text-white rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl backdrop-blur-sm whitespace-nowrap`}
          >
            {actionText}
          </button>
        </div>
