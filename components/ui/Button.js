export default function Button({ 
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:from-purple-600 hover:to-pink-600 focus:ring-purple-500 hover:shadow-gray-500/25',
    secondary: 'bg-gray-700 text-white hover:bg-gray-600 focus:ring-gray-500 hover:shadow-gray-500/25',
    outline: 'border border-purple-500 text-gray-400 hover:bg-gray-500/10 focus:ring-purple-500 hover:shadow-gray-500/25'
  }
