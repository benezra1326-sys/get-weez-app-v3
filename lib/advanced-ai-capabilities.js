...
export class AdvancedAICapabilities {
  ...
  buildContextualResponse(analysis, userProfile) {
    ...
    switch (intent) {
      case 'reservation':
        response += 'Parfait ! Je vais réserver exactement ce dont tu as besoin ! '
        break
      case 'recommendation':
        response += 'Voici mes meilleures recommandations personnalisées pour vous. '
        break
      case 'information':
        response += 'Parfait ! Je vais te donner toutes les informations dont tu as besoin ! '
        break
      default:
        response += 'Parfait ! Je vais t\'organiser quelque chose d\'exceptionnel ! '
    }
