...
export class LanguageDetector {
  constructor() {
    ...
    this.languagePatterns = {
      ...
      en: {
        ...
        questions: ['where', 'when', 'how', 'why', 'who', 'what', 'how much', 'can you', 'could you', 'would you', 'do you', 'are you'],
        common: ['i', 'you', 'he', 'she', 'we', 'they', 'the', 'a', 'an', 'and', 'or', 'but', 'with', 'without', 'for', 'in', 'on', 'under', 'is', 'are', 'was', 'were', 'have', 'has', 'had', 'will', 'would', 'can', 'could', 'should', 'must', 'want', 'need', 'like', 'love', 'prefer'],
        specific: ['restaurant', 'beach', 'club', 'villa', 'yacht', 'spa', 'eat', 'drink', 'go out', 'sleep', 'swim', 'dance', 'book', 'reserve', 'reservation', 'table', 'tonight', 'tomorrow', 'today', 'weekend', 'party', 'dinner', 'lunch', 'breakfast', 'sushi', 'food', 'meal', 'dining', 'cuisine']
      },
      es: {
  ...
  detectLanguage(message) {
    ...
    // Gérer les réponses de sélection de langue
    ...
    // Vérifier si c'est une sélection de langue
    for (const [key, lang] of Object.entries(languageSelections)) {
    ...
    // Détection simplifiée et plus efficace
    const words = text.split(' ')
    
    // Mots très spécifiques par langue (poids élevé)
    const languageIndicators = {
      en: ['want', 'need', 'like', 'love', 'prefer', 'sushi', 'food', 'meal', 'dining', 'cuisine', 'restaurant', 'beach', 'club', 'villa', 'yacht', 'spa', 'book', 'reserve', 'table', 'tonight', 'tomorrow', 'today', 'weekend', 'party', 'dinner', 'lunch', 'breakfast', 'i', 'you', 'he', 'she', 'we', 'they', 'the', 'a', 'an', 'and', 'or', 'but', 'with', 'without', 'for', 'in', 'on', 'under', 'is', 'are', 'was', 'were', 'have', 'has', 'had', 'will', 'would', 'can', 'could', 'should', 'must', 'my', 'your', 'his', 'her', 'our', 'their', 'friend', 'friends', 'good', 'great', 'nice', 'beautiful', 'amazing', 'wonderful', 'excellent', 'perfect', 'best', 'better', 'good', 'bad', 'terrible', 'awful', 'yes', 'no', 'maybe', 'sure', 'okay', 'ok', 'please', 'thank', 'thanks', 'welcome', 'sorry', 'excuse', 'help', 'helping', 'helped', 'know', 'knowing', 'knew', 'think', 'thinking', 'thought', 'see', 'seeing', 'saw', 'come', 'coming', 'came', 'go', 'going', 'went', 'get', 'getting', 'got', 'make', 'making', 'made', 'take', 'taking', 'took', 'give', 'giving', 'gave', 'tell', 'telling', 'told', 'ask', 'asking', 'asked', 'find', 'finding', 'found', 'look', 'looking', 'looked', 'work', 'working', 'worked', 'play', 'playing', 'played', 'live', 'living', 'lived', 'feel', 'feeling', 'felt', 'seem', 'seeming', 'seemed', 'try', 'trying', 'tried', 'leave', 'leaving', 'left', 'call', 'calling', 'called', 'move', 'moving', 'moved', 'turn', 'turning', 'turned', 'start', 'starting', 'started', 'stop', 'stopping', 'stopped', 'keep', 'keeping', 'kept', 'let', 'letting', 'put', 'putting', 'say', 'saying', 'said', 'use', 'using', 'used', 'find', 'finding', 'found', 'become', 'becoming', 'became', 'show', 'showing', 'showed', 'hear', 'hearing', 'heard', 'run', 'running', 'ran', 'bring', 'bringing', 'brought', 'write', 'writing', 'wrote', 'sit', 'sitting', 'sat', 'stand', 'standing', 'stood', 'lose', 'losing', 'lost', 'pay', 'paying', 'paid', 'meet', 'meeting', 'met', 'include', 'including', 'included', 'continue', 'continuing', 'continued', 'set', 'setting', 'learn', 'learning', 'learned', 'change', 'changing', 'changed', 'lead', 'leading', 'led', 'understand', 'understanding', 'understood', 'watch', 'watching', 'watched', 'follow', 'following', 'followed', 'stop', 'stopping', 'stopped', 'create', 'creating', 'created', 'speak', 'speaking', 'spoke', 'read', 'reading', 'allow', 'allowing', 'allowed', 'add', 'adding', 'added', 'spend', 'spending', 'spent', 'grow', 'growing', 'grew', 'open', 'opening', 'opened', 'walk', 'walking', 'walked', 'win', 'winning', 'won', 'offer', 'offering', 'offered', 'remember', 'remembering', 'remembered', 'love', 'loving', 'loved', 'consider', 'considering', 'considered', 'appear', 'appearing', 'appeared', 'buy', 'buying', 'bought', 'wait', 'waiting', 'waited', 'serve', 'serving', 'served', 'die', 'dying', 'died', 'send', 'sending', 'sent', 'expect', 'expecting', 'expected', 'build', 'building', 'built', 'stay', 'staying', 'stayed', 'fall', 'falling', 'fell', 'cut', 'cutting', 'reach', 'reaching', 'reached', 'kill', 'killing', 'killed', 'remain', 'remaining', 'remained', 'suggest', 'suggesting', 'suggested', 'raise', 'raising', 'raised', 'pass', 'passing', 'passed', 'sell', 'selling', 'sold', 'require', 'requiring', 'required', 'report', 'reporting', 'reported', 'decide', 'deciding', 'decided', 'pull', 'pulling', 'pulled'],
      fr: ['je', 'tu', 'il', 'elle', 'nous', 'vous', 'ils', 'elles', 'le', 'la', 'les', 'un', 'une', 'des', 'du', 'de', 'à', 'et', 'ou', 'mais', 'avec', 'sans', 'pour', 'dans', 'sur', 'sous', 'bonjour', 'salut', 'merci', 'ça', 'comment', 'veux', 'voudrais', 'manger', 'boire', 'sortir', 'dormir', 'nager', 'danser'],
      es: ['hola', 'buenos', 'días', 'tardes', 'noches', 'yo', 'tú', 'él', 'ella', 'nosotros', 'vosotros', 'ellos', 'ellas', 'el', 'la', 'los', 'las', 'un', 'una', 'de', 'del', 'y', 'o', 'pero', 'con', 'sin', 'para', 'en', 'sobre', 'mi', 'tu', 'su', 'nuestro', 'vuestro', 'su', 'amigo', 'amiga', 'amigos', 'amigas', 'gracias', 'por', 'favor', 'sí', 'no', 'tal', 'vez', 'claro', 'perfecto', 'excelente', 'bueno', 'buena', 'malo', 'mala', 'quiero', 'necesito', 'me', 'gusta', 'gustan', 'comer', 'beber', 'ir', 'venir', 'hacer', 'tener', 'ser', 'estar', 'hablar', 'ver', 'oír', 'saber', 'conocer', 'poder', 'deber', 'querer', 'necesitar', 'preferir', 'amar', 'odiar', 'vivir', 'trabajar', 'jugar', 'estudiar', 'aprender', 'enseñar', 'ayudar', 'buscar', 'encontrar', 'perder', 'ganar', 'comprar', 'vender', 'pagar', 'costar', 'valer', 'cambiar', 'mover', 'parar', 'empezar', 'terminar', 'continuar', 'acabar', 'volver', 'regresar', 'llegar', 'salir', 'entrar', 'subir', 'bajar', 'abrir', 'cerrar', 'dar', 'recibir', 'tomar', 'poner', 'quitar', 'sacar', 'meter', 'traer', 'llevar', 'dejar', 'permitir', 'prohibir', 'obligar', 'forzar', 'intentar', 'probar', 'probarse', 'vestirse', 'desvestirse', 'dormir', 'despertar', 'soñar', 'pensar', 'creer', 'saber', 'conocer', 'recordar', 'olvidar', 'entender', 'comprender', 'explicar', 'decir', 'contar', 'preguntar', 'responder', 'llamar', 'telefonear', 'escribir', 'leer', 'escuchar', 'mirar', 'ver', 'mostrar', 'enseñar', 'aprender', 'estudiar', 'trabajar', 'jugar', 'divertirse', 'reír', 'llorar', 'sonreír', 'gritar', 'hablar', 'callar', 'escuchar', 'oír', 'sentir', 'tocar', 'oler', 'gustar', 'preferir', 'amar', 'querer', 'odiar', 'detestar', 'temer', 'tener', 'miedo', 'preocuparse', 'relajarse', 'descansar', 'dormir', 'soñar', 'despertar', 'levantar', 'sentar', 'parar', 'caminar', 'correr', 'saltar', 'nadar', 'volar', 'conducir', 'manejar', 'viajar', 'visitar', 'conocer', 'saber', 'entender', 'comprender', 'explicar', 'decir', 'contar', 'preguntar', 'responder', 'llamar', 'telefonear', 'escribir', 'leer', 'escuchar', 'mirar', 'ver', 'mostrar', 'enseñar', 'aprender', 'estudiar', 'trabajar', 'jugar', 'divertirse', 'reír', 'llorar', 'sonreír', 'gritar', 'hablar', 'callar', 'escuchar', 'oír', 'sentir', 'tocar', 'oler', 'gustar', 'preferir', 'amar', 'querer', 'odiar', 'detestar', 'temer', 'tener', 'miedo', 'preocuparse', 'relajarse', 'descansar', 'dormir', 'soñar', 'despertar', 'levantar', 'sentar', 'parar', 'caminar', 'correr', 'saltar', 'nadar', 'volar', 'conducir', 'manejar', 'viajar', 'visitar', 'conocer', 'saber', 'entender', 'comprender', 'explicar', 'decir', 'contar', 'preguntar', 'responder', 'llamar', 'telefonear', 'escribir', 'leer', 'escuchar', 'mirar', 'ver', 'mostrar', 'enseñar', 'aprender', 'estudiar', 'trabajar', 'jugar', 'divertirse', 'reír', 'llorar', 'sonreír', 'gritar', 'hablar', 'callar', 'escuchar', 'oír', 'sentir', 'tocar', 'oler', 'gustar', 'preferir', 'amar', 'querer', 'odiar', 'detestar', 'temer', 'tener', 'miedo', 'preocuparse', 'relajarse', 'descansar', 'dormir', 'soñar', 'despertar', 'levantar', 'sentar', 'parar', 'caminar', 'correr', 'saltar', 'nadar', 'volar', 'conducir', 'manejar', 'viajar', 'visitar'],
      it: ['ciao', 'buongiorno', 'buonasera', 'io', 'tu', 'lui', 'lei', 'noi', 'voi', 'loro', 'il', 'la', 'i', 'le', 'un', 'una', 'e', 'o', 'ma', 'con', 'senza', 'per', 'in', 'su', 'sotto'],
      de: ['hallo', 'guten', 'tag', 'abend', 'ich', 'du', 'er', 'sie', 'wir', 'ihr', 'der', 'die', 'das', 'ein', 'eine', 'und', 'oder', 'aber', 'mit', 'ohne', 'für', 'in', 'auf', 'unter']
    }
    ...
    console.log('🔍 Debug détection langue:', { text, words, scores, bestMatch })
    
    // Seulement demander confirmation pour les mots très courts et ambigus
    const ambiguousWords = ['hello', 'hi', 'hey', 'ciao', 'hola']
    const hasAmbiguousWord = ambiguousWords.some(word => text.includes(word))
    const isShortMessage = words.length <= 2
    const isLowScore = bestMatch.score < 1
    
    if (hasAmbiguousWord && isShortMessage && isLowScore) {
      return {
        language: 'ambiguous',
        confidence: 'low',
        scores,
        ...
        suggestedLanguages: ['en', 'fr', 'es', 'it']
      }
    }
  ...
  getLanguageInfo(language) {
    const languageInfo = {
      fr: {
        name: 'Français',
        flag: '🇫🇷',
        systemPrompt: `Tu es "Gliitz", un concierge de luxe EXPERT à Marbella. Tu es FRIENDLY, BIENVEILLANT, DÉVOUÉ au client.
...
EXEMPLES CONCRETS :
Message : "bonjour"
Réponse : "Salut ! 😊 Je suis Gliitz, ton concierge personnel dévoué à Marbella ! Je suis là pour te faire vivre des expériences exceptionnelles. Que puis-je organiser pour toi aujourd'hui ?"
