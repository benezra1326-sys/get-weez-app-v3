          ...
          <div className="lg:col-span-1">
            <div className={`p-6 rounded-2xl ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
              ...
              <div className="space-y-3">
                <button className="w-full bg-gradient-to-r from-gray-600 to-gray-600 text-white py-3 px-6 rounded-lg font-semibold hover:from-gray-700 hover:to-gray-700 transition-all duration-300 transform hover:scale-105">
                  Réserver maintenant
                </button>
                <button className="w-full border border-gray-600 text-gray-600 py-3 px-6 rounded-lg font-semibold hover:bg-gray-50 transition-all duration-300">
                  Contacter
                </button>
              </div>
            </div>
